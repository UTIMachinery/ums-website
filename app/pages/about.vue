    ...
    <section class="page-hero">
      ...
      <div class="wrap hero-content">
        <div class="hero-copy">
          ...
          <h1>Meet Jonathan Lester</h1>
          <p class="hero-subhead">The person behind Used Machinery Source.</p>
          <p class="lead">Helping buyers and sellers find the right machinery solution for over 35 years.</p>
        </div>
      </div>
    </section>
    ...
    <section class="section light">
      <div class="wrap">
        <div class="section-heading">
          <p class="eyebrow dark">EXPERIENCE AT A GLANCE</p>
          <h2>Experience, Relationships and Personal Service.</h2>
        </div>
        <div class="values">
          <article><h3>35+ Years of Experience</h3><p>Serving the CNC machinery industry since 1988.</p></article>
          <article><h3>Independent Guidance</h3><p>Straightforward advice focused on finding the right solution for your needs.</p></article>
          <article><h3>North American Network</h3><p>Long-standing relationships with manufacturers, dealers, financial institutions and machinery professionals throughout North America.</p></article>
          <article><h3>Personal Service</h3><p>Work directly with Jonathan from the first conversation through closing.</p></article>
        </div>
      </div>
    </section>

    <section class="cta"><div class="wrap cta-inner"><div><h2>Have a Machinery Need?</h2><p>Tell us what you are looking for—or what you have available.</p></div><div class="cta-actions"><NuxtLink to="/equipment" class="btn light-btn">Search Equipment</NuxtLink><NuxtLink to="/contact" class="btn orange-btn">Contact Us</NuxtLink></div></div></section>
  </main>
</template>
