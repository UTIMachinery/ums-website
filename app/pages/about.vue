    ...
    <section class="page-hero">
      ...
      <div class="wrap hero-content">
        <div class="hero-copy">
          ...
          <p class="lead">Helping buyers and sellers find the right machinery solution through straightforward information, responsive service and decades of industry experience.</p>
        </div>
      </div>
    </section>
    ...
    <section class="section light">
      <div class="wrap">
        <div class="section-heading">
          <p class="eyebrow dark">WHAT MATTERS TO US</p>
