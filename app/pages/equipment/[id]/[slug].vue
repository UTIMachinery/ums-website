<template>
  ...
  <div class="machine-top">
   ...
   <button type="button" class="back-to-equipment" @click="backToEquipment">‹ Back to Equipment Results</button>
    <h1 v-if="machine">{{ machine.Year }} {{ machine.Manufacturer }} {{ machine.Model }}</h1>
...
const featuredMachines = computed(() => {
  ...
  const start = (Number(current.InvID) || 0) % eligible.length
...
@media(max-width:650px){.similar-machines-grid{grid-template-columns:1fr}}
</style>