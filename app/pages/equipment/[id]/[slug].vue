...
<p v-if="manufacturerSpecLink" class="machine-research-link"><NuxtLink :to="manufacturerSpecLink">Research {{ machine.Manufacturer }} CNC lathe specifications →</NuxtLink></p>
