  ...
  <main class="manufacturer-page">
    ...
    <section class="info">
      <div class="wrap">
        ...
        <div v-if="manufacturer.specLinks?.length" class="library-box"><div class="kicker">UMS SPECIFICATION LIBRARY</div><h3>Research Historical {{ manufacturer.name }} Models &amp; Specifications</h3><p>Use the UMS historical library to research {{ manufacturer.name }} models by machine type, model and recorded year/configuration. Historical specifications are reference information and are separate from current machines for sale.</p><div class="library-links"><NuxtLink v-for="link in manufacturer.specLinks" :key="link.to" :to="link.to">{{ link.label }} →</NuxtLink></div></div>
        <div class="links">
