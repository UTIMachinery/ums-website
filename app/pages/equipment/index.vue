...
const route=useRoute();const applyingRouteFilters=ref(false);const selectedCategory=ref('all');const searchTerm=ref('');const showMachineNeededForm=ref(false);const machineNeededSending=ref(false);const machineNeededSent=ref(false)
