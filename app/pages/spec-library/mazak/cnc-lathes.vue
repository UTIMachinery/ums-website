        ...
        <div class="family-grid">
          ...
          <article class="family-card featured">
            ...
            <div class="model-links">
              <NuxtLink to="/spec-library/mazak/quick-turn-10" class="text-link">Quick-Turn 10 specifications →</NuxtLink>
              <NuxtLink to="/spec-library/mazak/quick-turn-18n" class="text-link">Quick-Turn 18N specifications →</NuxtLink>
