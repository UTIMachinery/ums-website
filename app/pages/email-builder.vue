        ...
        <div class="preview-wrap">
          ...
          <div class="email-preview">
            <div class="email-header">
              <img src="/Images/ums-logo.png" alt="Used Machinery Source" class="email-logo" />
              <div class="contact-links">
                <a href="tel:+12569801200">(256) 980-1200</a>
                <span>•</span>
                <a href="mailto:jon@usedms.com">jon@usedms.com</a>
                <span>•</span>
                <a href="https://usedmachinerysource.com" target="_blank">usedmachinerysource.com</a>
              </div>
            </div>
...
const machineTitle=m=>[m.Year,m.Manufacturer,m.Model].filter(Boolean).join(' ')
